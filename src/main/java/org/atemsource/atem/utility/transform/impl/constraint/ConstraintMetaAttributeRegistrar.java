...
public class ConstraintMetaAttributeRegistrar
{
	...
	{
		metaAttributeService.addSingleMetaAttribute(PossibleValues.META_ATTRIBUTE_CODE, entityTypeRepository.getEntityType(Attribute.class),
			entityTypeRepository.getEntityType(PossibleValues.class));
