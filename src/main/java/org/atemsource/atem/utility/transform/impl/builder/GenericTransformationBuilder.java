...
@Component
@Scope("prototype")
public class GenericTransformationBuilder<A, B>
		extends
		AbstractAttributeTransformationBuilder<A, B, GenericTransformationBuilder<A, B>> {
	private Set<String> sourceAttributes=new HashSet<String>();
	private Set<Attribute<?, ?>> targetAttributes= new HashSet<Attribute<?,?>>();
	...
	public void transform(JavaTransformation<A, B> transformation) {
