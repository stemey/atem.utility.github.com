...
public class EntityUtils
{
	 ...
	 */
	public static <T> EntityType<T> getCommonAncestor(EntityType<?> a, EntityType<?> b)
	{
	 ...
	 */
	public static <T, S extends T, U extends T> void merge(S from, U to, Class<T> commonSuperClass)
	{
		EntityType<T> entityType =
			BeanLocator.getInstance().getInstance(EntityTypeRepository.class).getEntityType(commonSuperClass);
	 ...
	 * @param commonSuperClass the common super class of from and to
	 */
	public static <T, S extends T, U extends T> void mergeRecursive(S from, U to, EntityType<T> entityType)
	{
		do
		{
			merge(from, to, entityType);
