...
public class CollectionToMapTest {
	...
	private EntityTypeTransformation<?, ?> createEntityBTransformation() {
		if (entityBTransformation == null) {
			TypeTransformationBuilder<?, ?> bBuilder = transformationBuilderFactory
					.create(EntityB.class, dynamicEntityTypeSubrepository
							.createBuilder("EntityB"));
	...
	public void test() {
		TypeTransformationBuilder<?, ?> builder = transformationBuilderFactory
				.create(EntityA.class, dynamicEntityTypeSubrepository
						.createBuilder("collectionToMap"));
